...
class PreviosFragment : Fragment() {
    private lateinit var sessionManager: SessionManager
    private lateinit var apiClient: ApiClient

    private var ordersList:MutableList<Tickets> = ArrayList()

    private var ordersListAddapter: PreviousOrdersAdapter?=null
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_previos, container, false)
    }
    ...
    private fun initRVAdapter(){
        ...
        ordersListAddapter = PreviousOrdersAdapter(mContext!!, ordersList)
    ...
    private fun getUserOrders() {
        ...
        apiClient.getApiService(mContext!!).getUserPreviousOrders()
    ...
    private fun getOstahOrders() {
        ...
        apiClient = ApiClient()
        sessionManager = SessionManager(mContext!!)
        apiClient.getApiService(mContext!!).getOstahPreviousOrders()
